...
const TickMark = () => {
  return (
    <span aria-label=" Sent " data-icon="msg-check" >
      <svg
        viewBox="0 0 12 11"
        height="11"
        width="16"
...
const DoubleTickMark = () => {
  return (
    <div className="flex">
      <div className="do8e0lj9 l7jjieqr k6y3xtnu">
        <span aria-label=" Read " data-icon="msg-dblcheck" className="S7n_s">
          <svg
            viewBox="0 0 16 11"
            height="11"
            width="16"
...
const MessageItem = ({ isReceived, message, time }) => {
  return (
    <div
      className={` py-[0.35rem] rounded-b-md flex max-w-[600px] text-sm ${
        isReceived
          ? "bg-white rounded-e-md"
          : "bg-[#d9fdd3] self-end rounded-s-md "
      } w-fit px-4`}
    >
      ...
      <div className="date text-xs ml-2 mt-auto flex gap-[0.1rem] items-center">
        {time}
        <DoubleTickMark />
      </div>
    </div>
